...
class PFCandidate {
 public:
  ...
  void setDistTkHcalMatch(double x) { distTkHcalMatch_ = x; }
  void setDistTkHcalSecondCluster(double x) { distTkHcalSecondCluster_ = x; }
  void setHcalSecondEnergy(float x) { hcalSecondEnergy_ = x; }
  ...
  double getTruthEnergy() const { return truthEnergy_; }
  int getTruthPdgId() { return truthPdgId_; }

  double getDistTkHcalMatch() const { return distTkHcalMatch_; }
  double getDistTkSecondHcalCluster() const { return distTkHcalSecondCluster_; }
  float getHcalSecondEnergy() const { return hcalSecondEnergy_; }
 ...
 private:
  ...
  /* Distance [multiples of RMS value of hcal cluster] between matched track and hcal cluster */
  double distTkHcalMatch_{0};
  double distTkHcalSecondCluster_{0};
  float hcalSecondEnergy_{0}; // energy of second highest energy cluster (if it exists)
